...
public class InputManager : MonoBehaviour {
	...
	public static bool keyboardUse, joystickUse;
	...
	public KeyCode AltUp = KeyCode.W;
	public KeyCode AltDown = KeyCode.S;
	public KeyCode PunchKey = KeyCode.Z;
	public KeyCode KickKey = KeyCode.X;
	public KeyCode DefendKey = KeyCode.C;
	public KeyCode AltPunchKey = KeyCode.I;
	public KeyCode AltKickKey = KeyCode.O;
	public KeyCode AltDefendKey = KeyCode.P;
	...
	void KeyboardControls(){
		...
		if(Input.GetKey(AltLeft)) x = -1f;
		if(Input.GetKey(AltRight)) x = 1f;
		if(Input.GetKey(AltUp)) y = 1f;
		if(Input.GetKey(AltDown)) y = -1f;
		...
		if(Input.GetKeyDown(AltPunchKey)){
			CombatInputEvent("Punch");
		}

		if(Input.GetKeyDown(AltKickKey)){
			CombatInputEvent("Kick");
		}

		if(Input.GetKey(AltDefendKey)){
			CombatInputEvent("Defend");
		}
	...
	public static void SetJoystick(){
		joystickUse = true;
		keyboardUse = false;
	}
}
